...
function calcSew(rid, idx) {
    ...
    switch(type){
        ...
        case 'tul_bant':{ const A=gv('sa-'+rid+'-'+idx),B=gv('sb-'+rid+'-'+idx),W=gv('sw-'+rid+'-'+idx),D=gv('sd-'+rid+'-'+idx),K=gv('sk-'+rid+'-'+idx)||1,P=gv('sp-'+rid+'-'+idx); total=Math.round(((A*2)+(B*2)+(W*4))*D*(1+P/100)*K); break; }
